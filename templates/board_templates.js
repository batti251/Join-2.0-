...
function getTaskOverlay(indexTask, currentTask, overlay) {
  overlay.innerHTML = `
    ...
    <div class="task-overlay-meta-wrap creator">
      ...
      ${
        currentTask.creator == "external" ? `<div class="creator-external"><img src="../assets/icons/world.svg"> Extern </div><div class="creator-name">${currentTask.name}</div><a href="mailto:${currentTask.mail}?subject=Join: Your Task ${currentTask.title}" class="email-external"><img src="../assets/icons/mail_attach.svg">E-Mail</a>` : 
